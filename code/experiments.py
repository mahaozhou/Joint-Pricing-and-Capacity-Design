...
Run: python code/experiments.py --workers 4
"""
import os
...
from paths import MAIN as OUT, STAFFING
OUT.mkdir(parents=True, exist_ok=True)
STAFFING.mkdir(parents=True, exist_ok=True)
...
def run(workers):
    ...
    (STAFFING/'staffing_transfers.json').write_text(json.dumps(staffing,indent=2))
